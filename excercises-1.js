...
// console.log(avg(2, 3, 4) === 3)
// console.log(avg(234, 63, 234) === 177)
// console.log(avg(123, 234, 345) === 234)
...
// console.log(getLength('Michael') === 7)
// console.log(getLength('Javascript') === 10)
// console.log(getLength('supercalifragilisticexpialidocious') === 34)
